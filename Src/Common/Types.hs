...
str2bic :: String -> BIC
str2bic str = if (isValidBic str) then (C_BIC str) else error "Invalid BIC."

str2unp :: String -> UNP
str2unp str = if (isValidUnp str)  then (C_UNP str) else error "Invalid UNP."

str2acc :: String -> ACC
str2acc str = if (isValidAcc str) then (C_ACC str) else error "Invalid BIC."
