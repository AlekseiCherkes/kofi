...
company = TInfo {tname = "Company",
	         cols = [ CInfo {cname = "unp", descr = (StringT, False)}
                        ...
                        -- , CInfo {cname = "open_key", descr = (StringT, False)}
                        ]
                }

account = TInfo {tname = "Account",
                 cols = [ CInfo {cname = "id", descr = (StringT, False)}
                        , CInfo {cname = "owner_id", descr = (StringT, False)}
